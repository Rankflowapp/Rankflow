// Portraits officiels des agents Valorant depuis valorant-api.com
// Style "agent select" (portrait de la tête uniquement)
...
export function getAgentImage(agentName) {
  return agentImages[agentName] || null
}